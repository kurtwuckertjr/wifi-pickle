![logo](https://raw.githubusercontent.com/P0cL4bs/WiFi-Pickle/master/docs/logo.png)

[![build](https://travis-ci.org/P0cL4bs/WiFi-Pickle.svg)](https://travis-ci.org/P0cL4bs/WiFi-Pickle/)

WiFi-Pickle - Framework for Rogue Wi-Fi Access Point Attack
### Description
The WiFi-Pickle is a rogue AP framework to easily create these fake networks, all while forwarding legitimate traffic to and from the unsuspecting target. It comes stuffed with features, including rogue Wi-Fi access points, deauth attacks on client APs, a probe request and credentials monitor, transparent proxy, Windows update attack, phishing manager, ARP Poisoning, DNS Spoofing, Pickle-Proxy, and image capture on the fly. moreover, the WiFi-Pickle is a very complete framework for auditing Wi-Fi security check the list of features is quite broad.
...
- Python 2.7
```sh
 git clone https://github.com/P0cL4bs/WiFi-Pickle.git
 cd WiFi-Pickle
 ./installer.sh --install
```
or download [.deb](https://github.com/P0cL4bs/WiFi-Pickle/releases) file to install
``` sh
sudo dpkg -i wifi-pickle-0.8.5-all.deb
sudo apt-get -f install # force install dependencies if not install normally

```

refer to the wiki for [Installation](https://github.com/P0cL4bs/WiFi-Pickle/wiki/Installation)
...
* Pickle-Proxy (ProxyServer (mitmproxy API))
* Capture images on the fly
* TCP-Proxy (with [scapy](http://www.secdev.org/projects/scapy/))

### Donation
##### Patreon:
[![Patreon](https://cloud.githubusercontent.com/assets/8225057/5990484/70413560-a9ab-11e4-8942-1a63607c0b00.png)](http://www.patreon.com/wifipickle)
##### paypal:
...
```
#### About plugins
[plugins](https://github.com/P0cL4bs/WiFi-Pickle/wiki/Plugins) on the wiki 

### TCP-Proxy Server
A proxy that you can place between in a TCP stream. It filters the request and response streams with ([scapy](http://www.secdev.org/projects/scapy/) module) and actively modify packets of a TCP protocol that gets intercepted by WiFi-Pickle. this plugin uses modules to view or modify the intercepted data that possibly easiest implementation of a module, just add your custom module on  "plugins/analyzers/" automatically will be listed on TCP-Proxy tab.
...
```
#### About TCP-Proxy
[TCP-Proxy](https://github.com/P0cL4bs/WiFi-Pickle/wiki/TCP-PProxy) on the wiki 

### Screenshots
[Screenshot](https://github.com/P0cL4bs/WiFi-Pickle/wiki/Screenshots) on the wiki 

### FAQ
[FAQ](https://github.com/P0cL4bs/WiFi-Pickle/wiki/FAQ) on the wiki

### Contact Us
Whether you want to report a [bug](https://github.com/P0cL4bs/WiFi-Pickle/issues/new), send a patch or give some suggestions on this project, drop us or open [pull requests](https://github.com/P0cL4bs/WiFi-Pickle/pulls) 
