...
"""
Description:
    This program is a module for wifi-pickle.py. Report FIles Logger PDF or HTML
...
class frm_ReportLogger(PickleModule):
    ''' called report logger in files '''
    def __init__(self,sessions,parent = None):
        super(frm_ReportLogger, self).__init__(parent)
        self.setWindowTitle('WiFi-Pickle - Report Logger')
    ...
    def convertIt(self,printer):
        ...
        QtGui.QMessageBox.information(self, 'WiFi Pickle Report PDF', 'file PDF has been generated successfully.')
    ...
    def exportFilesSystem(self):
        ...
        if self.checkHTML.isChecked():
            ...
            if len(filename[0]) != 0:
                ...
                QtGui.QMessageBox.information(self, 'WiFi Pickle Report HTML', 'file logs has been saved successfully.')
